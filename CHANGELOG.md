...
- Added `sanitizeComponents` to validate and normalize component PURLs (empty purl detection, invalid purl handling, semver operator extraction)
...
- Added unit tests for component sanitization and semver utilities
